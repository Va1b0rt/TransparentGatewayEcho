...
Адреси `203.0.113.10` (VPS) і `198.51.100.10` (джерело доступу) у документації — лише приклади. Перед запуском підставте власні IP; реальні адреси зберігайте тільки в локальній конфігурації поза Git.
